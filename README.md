...
pipeline {
    ...
    stages {
        ...
        stage ("Git checkout") {
            steps {
                git branch: 'main', url: 'https://github.com/DevOps-Deepankar/DevSecOps-Project.git'
            }
        }
            ...
            steps {
                script {
                    withDockerRegistry(credentialsId: 'docker') {
                        sh "docker tag background-remover-python-app deepankar28/background-remover-python-app:latest"
                        sh "docker push deepankar28/background-remover-python-app:latest"
                    }
                }
            }
        }
            ...
            steps {
                script {
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker') {
                       sh 'docker-scout quickview deepankar28/background-remover-python-app:latest'
                       sh 'docker-scout cves deepankar28/background-remover-python-app:latest'
                       sh 'docker-scout recommendations deepankar28/background-remover-python-app:latest'
                   }
                }
            }
        }
        stage ("Deploy to Container") {
            steps {
                sh 'docker run -d --name background-remover-python-app -p 5100:5100 deepankar28/background-remover-python-app:latest'
            }
        }
    }
    post {
